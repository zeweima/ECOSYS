...
240   CONTINUE
     ...
     5+0.5*DV(NY,N)*SLOPE(2,NY,NX))/2.0
      ...
      ENDIF
C     WRITE(*,1111)'ALT',NX,NY,ALT(NY,NX)
...
C
      ...
      WRITE(*,3336)'NW',NY,NX,L,NU(NY,NX),NW(NY,NX)
     2,ICHK1,ICHK2,BKDS(L,NY,NX)
3336  FORMAT(A8,7I4,1E12.4)
      IF(BKDS(L,NY,NX).LE.ZERO)THEN
      ICHK1=1
      ENDIF
      IF(BKDS(L,NY,NX).GT.ZERO.AND.ICHK1.EQ.1
     2.AND.ICHK2.EQ.0)THEN 
      NW(NY,NX)=L
      ICHK2=1
      ENDIF
      ENDIF
