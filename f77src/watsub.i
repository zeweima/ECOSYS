# 1 "/cw3e/mead/projects/cwp101/uiuc/zma/Ecosys_model/modified/ecosys17102020_update_tile_drainage/f77src/watsub.f"
...
C
C     IF(I.GT.240.AND.N3.GE.10)THEN
C     WRITE(*,1118)'VOLX',I,J,M,N1,N2,N3,N4,N5,N6
C    2,VOLX(N3,N2,N1),DLYR(3,N3,N2,N1)
C    3,VOLW1(N3,N2,N1),VOLI1(N3,N2,N1)
C    5,ZEROS(N2,N1),ZEROS2(N2,N1)
1118  FORMAT(A8,9I4,12E12.4)
C     ENDIF
...
C    2,PSISM1(N3,N2,N1),PSISM1(N6,N5,N4),PSISA1,PSISAL,THETA1,THETAL
...
C
      IF(IPRC(NY,NX).GE.3.AND.DPTH(L,NY,NX).LT.DTBLY(NY,NX))THEN
      IF(PSISM1(L,NY,NX).GT.0.0098*(DPTH(L,NY,NX)-DTBLY(NY,NX)))THEN
      IFLGD=0
      DO 9568 LL=MIN(L+1,NL(NY,NX)),NL(NY,NX)
...
C
     ...
     2/VOLAH1(L,NY,NX)*DLYR(3,L,NY,NX)
      ...
      DPTHH=CDPTH(L,NY,NX)
      ENDIF
      IF(IPRC(NY,NX).GE.3.AND.DPTHH.LT.DTBLY(NY,NX)
     2.AND.VOLWH1(L,NY,NX).GT.ZEROS(NY,NX))THEN
      IFLGDH=0
      DO 9569 LL=MIN(L+1,NL(NY,NX)),NL(NY,NX)
...
C
     ...
     2AND.(CDPTH(NU(N2,N1)-1,N2,N1).LE.CDPTHI(N2,N1)
...
C
     ...
     2*(1.0-DTBLG(N2,N1))
      PSISWT=AMIN1(0.0,-PSISM1(N3,N2,N1)-0.03*PSISO(N3,N2,N1) 
...
C    4,PSISE(N3,N2,N1),PSISM1(N3,N2,N1),DPTH(N3,N2,N1),DTBLX(N2,N1)
...
C
     ...
     3-0.0098*AMAX1(0.0,DPTH(N3,N2,N1)-DPTHT(N2,N1)))
      IF(PSISWT.LT.0.0)PSISWT=PSISWT-PSISWD 
      FLWT=PSISWT*HCND(N,1,N3,N2,N1)*XNPH*AREA(N,N3,N2,N1)
c     2*(1.0-AREAU(N3,N2,N1))/(RCHGFU+1.0)*RCHGFT                       zma changes 20200205
     2*(1.0-AREAU(N3,N2,N1))/(TILED+1.0)*RCHGFT        
...
C     IF((I/10)*10.EQ.I.AND.J.EQ.15)THEN
C     WRITE(*,4445)'DISCHMD',I,J,M,N1,N2,N3,M4,M5,M6,N,NN,IFLGU
C    2,XN,FLWL(N,M6,M5,M4),FLWT,PSISWT,PSISWD,HCND(N,1,N3,N2,N1)
C    3,AREA(N,N3,N2,N1),AREAU(N3,N2,N1),RCHGFU,RCHGFT
C    4,PSISE(N3,N2,N1),PSISM1(N3,N2,N1),DPTH(N3,N2,N1),DTBLY(N2,N1)
C    2,PSISO(N3,N2,N1),0.0098*(DPTH(N3,N2,N1)-DTBLY(N2,N1))
C    3,0.0098*AMAX1(0.0,DPTH(N3,N2,N1)-DPTHT(N2,N1))
C     ENDIF
      ENDIF
C
...
C
      IF(IFLGDH.EQ.0.AND.RCHGFT.NE.0.0)THEN
      PSISWD=XN*0.005*SLOPE(N,N2,N1)*DLYR(N,N3,N2,N1)
     2*(1.0-DTBLG(N2,N1))
      PSISWTH=-0.03*PSISO(N3,N2,N1)
     ...
     3-0.0098*AMAX1(0.0,DPTHH-DPTHT(N2,N1))
      IF(PSISWTH.LT.0.0)PSISWTH=PSISWTH-PSISWD
      FLWTH=PSISWTH*CNDH1(N3,N2,N1)*AREA(N,N3,N2,N1)  
c     2*(1.0-AREAU(N3,N2,N1))/(RCHGFU+1.0)*RCHGFT*XNPH                        zma changes 20220205
     2*(1.0-AREAU(N3,N2,N1))/(TILED+1.0)*RCHGFT*XNPH 
      FLWTHL=AMAX1(FLWTH,AMIN1(0.0,-XH(N,N3,N2,N1) 
     2*(VOLWH1(N3,N2,N1)+FLWHL(3,N3,N2,N1)-FLWHL(3,N3+1,N2,N1))))
...
C
     ...
     2.AND.(VOLP2.GT.ZEROS2(NY,NX).OR.BKDS(N2,N2,N1).LT.ZERO))THEN
      PSISWD=XN*0.005*SLOPE(N,N2,N1)*DLYR(N,N3,N2,N1)
     2*(1.0-DTBLG(N2,N1))
      PSISUT=AMAX1(0.0,-PSISM1(N3,N2,N1)-0.03*PSISO(N3,N2,N1) 
     2+0.0098*(DPTH(N3,N2,N1)-DTBLX(N2,N1)))
...
C    3,FLWU,FLWUL,PSISM1(N3,N2,N1),PSISO(N3,N2,N1)
C    4,PSISUT,HCND(N,1,N3,N2,N1),0.0098*(DPTH(N3,N2,N1)-DTBLX(N2,N1))
